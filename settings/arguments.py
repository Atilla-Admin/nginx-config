...
class ArgumentsParser():
    ...
    def __init__(self, auto_parse=True):
        ...
        self.parser.add_argument(
                'proxy-pass',
                help='proxy pass address')

        self.ssl_method.add_argument(
                '--use-ssl',
                '-us',
        ...
        self.ssl_group.add_argument(
                '--ssl-path',
                help='path in which SSL files can be found',
                dest='ssl_path')
        ...
        self.parser.add_argument(
                '--overwrite-output',
                help='owerwrite the output file if it already exists',
                default=None,
                action='store_true',
